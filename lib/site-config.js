 ...
 * @param {string} [alt]
 */
export function ogImageMetadata(src, alt = SITE_OG_DEFAULT_ALT) {
...
/**
 * 포스트 상세 공개 경로 `/blog/[slug]` — canonical·내부 링크·사이트맵과 동일하게 사용.
 * @param {string} slug
 */
export function postDetailPath(slug) {
...
/**
 * 포스트 상세 절대 URL (`/blog/[slug]`)
 * @param {string} slug
 */
export function absolutePostUrl(slug) {
  return absolutePageUrl(postDetailPath(slug));
}
