...
/**
 * 구글 서치 콘솔 — 추가 소유자·재검증용 HTML 태그 `content` (첫 번째 토큰과 동시 유지).
 * 도메인 속성 DNS TXT 복사용: `docs/search-console-dns-txt.txt`
 */
export const GOOGLE_SITE_VERIFICATION_SECOND =
  "scORv1uziTYs35Nqp4flWcmLya5LN_gzWG1HiYSnNe4";
...
export const SITE_NAME = "아이다호 편집자의 테크 바이브";

/** Article·JSON-LD `author` 등에 쓰는 표시명 (한곳만 수정) */
export const AUTHOR_NAME = "블로그 운영자";

export const DEFAULT_DESCRIPTION =
  "미국 시골 라이프와 AI 코딩에 관해 이야기합니다. 아이다호의 숲과 AI 코드 사이, 그 어딘가의 기록.";
