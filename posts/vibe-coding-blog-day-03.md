...
이번 포스팅에서는 그 설계도를 현실로 바꿔줄 **AI 코딩 비서를 영입**합니다.
...
2. 화면에 큰 초록색 버튼 <strong>[Get Node.js]</strong>를 클릭합니다.
...
4. **전부 ‘Next’만 누르세요.** 옵션을 바꿀 필요 없습니다(중간에 동의 요청 체크박스가 나오면 체크합니다다). 진짜 그냥 Next → Next → Next → Install → Finish.
...
2. 화면 오른쪽의 <strong>[Install for Windows]</strong> 버튼을 클릭합니다.
...
<figure>
  <img src="/image-day03/day03_09.png" alt="GitHub 홈 화면" class="md-img-natural" loading="lazy" />
  <figcaption>GitHub 홈 화면</figcaption>
</figure>
...
<div class="not-prose my-6">
  <img
    src="/image-day03/day03_11.png"
    alt="깃허브 저장소 생성 화면"
    class="ml-0 block w-3/4 rounded-lg border border-border object-contain dark:border-dm-border"
    loading="lazy"
  />
</div>
...
> <strong>[주의]</strong> **README, .gitignore, license는 절대 체크하지 마세요.** 체크하면 GitHub에 파일이 먼저 생겨버려서, 나중에 내 컴퓨터 코드를 올릴 때 충돌이 납니다. 깨끗한 빈 방으로 만들어야 합니다.
...
> <strong>[주의]</strong> 폴더 이름은 **영어, 소문자, 하이픈(-)만** 쓰세요. ‘내블로그’, ‘My Blog’, ‘my blog’ 전부 안 됩니다. 나중에 에러의 원인이 됩니다. 개발 세계에서 폴더 이름에 한글과 띄어쓰기는 ‘금기’입니다.
