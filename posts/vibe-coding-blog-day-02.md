...
<div class="not-prose wireframe-gshape wireframe-gshape--table" role="img" aria-label="본문 안 광고 황금 위치 4곳">
  <table class="wireframe-table">
    <tbody>
      <tr>
        <th scope="row">① 제목 바로 아래</th>
        <td class="wireframe-table__hint">← 첫 시선이 닿는 곳</td>
      </tr>
      <tr>
        <td class="wireframe-table__span" colspan="2">본문 도입부 (3~4문단)</td>
      </tr>
      <tr>
        <th scope="row">② 첫 소제목(H2) 위</th>
        <td class="wireframe-table__hint">← 스크롤이 멈추는 곳</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td class="wireframe-table__hint">← 읽기 흐름의 “쉼표”</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td class="wireframe-table__hint">← “다 읽었다”의 여유</td>
      </tr>
    </tbody>
  </table>
</div>
...
<div class="not-prose wireframe-gshape" role="img" aria-label="데스크톱 메인 페이지 와이어프레임">
  ...
  <div class="wireframe-gshape__row wireframe-gshape__row--footer">소개 | 개인정보처리방침 | 문의 | © 2025</div>
</div>
