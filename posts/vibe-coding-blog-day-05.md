...
1. **AI가 파일을 만들 때마다 [Accept] 또는 [Apply], 또는 [run] 등을 눌러주세요.** 이는 AI가 제안한 변경사항을 승인하는 과정으로, 해당 메시지가 뜨지 않고 알아서 진행되는 경우도 있습니다. 
2. **중간에 AI의 작업이 멈추면서 질문이 오면 [Yes] 또는 [진행해줘]라고 답하세요.**
